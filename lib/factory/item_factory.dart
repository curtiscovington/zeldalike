...
class ItemFactory {
  ...
  static List<Item> create() {
    ...
    items.add(Bow("Bow", "Bow defense increases health by 50.", 25, 75, 20));
    items.add(Boomerang("Boomerang", "Boomerang defense increases health by 50.", 50, 100, 30));
    items.add(Wand("Wand", "Wand defense increases health by 50.", 100, 200, 100));
